...
class Textractor:
    ...
    def processDocument(self, ips, i, document, outputDir):
        ...
        if(response):
            ...
            opg = OutputGenerator(response, name, outputDir,
    ...
    def run(self, args):
        ...
        outputDir = ips["outputDir"]

        for document in ips["documents"]:

        #     outputDir = pathlib.PurePath(document)
        # print("output directory = ")
        # print (outputDir)

            self.processDocument(ips, i, document, outputDir)
